using ClinicNestWebApi.Util;
using System.ComponentModel.DataAnnotations;

namespace ClinicNestWebApi.DTOs
{
    public class AlteracaoUsuarioDTO 
    {
        ...
        public AlteracaoUsuarioDTO(string loginUsuario, string email, string telefoneUsuario, string telefoneFuncionario, bool habilitado, bool master, int funcao)
        {
